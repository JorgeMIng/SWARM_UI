...
local DroneProtocolPageSegment1 = DroneProtocolPage:subclass()

function DroneProtocolPageSegment1:init(root,init_config)
	expect(1, root, "table")
	
	DroneProtocolPageSegment1.superClass.init(self,root,init_config)
...
function DroneProtocolPageSegment1:refresh()
...
return DroneProtocolPageSegment1