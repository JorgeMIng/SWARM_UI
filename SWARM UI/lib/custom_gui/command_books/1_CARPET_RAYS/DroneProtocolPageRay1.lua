...
local DroneProtocolPageRay1 = DroneProtocolPage:subclass()


function DroneProtocolPageRay1:init(root,init_config)
	expect(1, root, "table")
	
	DroneProtocolPageRay1.superClass.init(self,root,init_config)
...
function DroneProtocolPageRay1:refresh()
